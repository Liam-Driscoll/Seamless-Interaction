...
def createFile(participant):
    try:
        ...
        with open(participant+'.csv', 'a', newline='') as csv_file:
            fieldnames = ["date", "time", "completion_result", "breath_action", "force", "respiration_rate", "participant_id", "heart_rate", "baseline_hr", "pattern_duration", "trial_number", "guidance_type", "event"]
